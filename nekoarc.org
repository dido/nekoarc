...
** TODO basic data types [11/20]
    ...
    - [ ] Weak references
    - [ ] Objects
** TODO Runtime Built-In Functions [4/19]
   ...
   - [-] Type handling [4/5]
     - [ ] coerce [0/8]
       - [ ] Fixnum conversions [0/4]
	 - [ ] fixnum -> fixnum (trivial)
         - [ ] flonum -> fixnum
         - [ ] string -> fixnum
         - [ ] rune -> fixnum
       - [ ] Flonum conversions [0/3]
	 - [ ] flonum -> flonum (trivial)
	 - [ ] fixnum -> flonum
	 - [ ] string -> flonum
       - [ ] Rune conversions [0/2]
         - [ ] rune -> rune (trivial)
	 - [ ] fixnum -> rune
       - [ ] String conversions [0/8]
	 ...
	 - [ ] cons -> string
       ...
       - [ ] Symbol conversions [0/2]
         ...
         - [ ] string -> symbol
       - [ ] Cons conversions [0/2]
         - [ ] cons -> cons (trivial)
         - [ ] vector -> cons
       - [ ] Table conversions [0/1]
         - [ ] table -> table (trivial)
